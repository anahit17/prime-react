...
import { setClients } from "../../store/client/action";
...
export default function CreateClient() {
  ...
  const onSubmit = async (data) => {
    await axios
      .post(`${process.env.REACT_APP_API_URL}/addNewClient`, data)
      .then((res) => {
  ...
  return (
    <div className="form-demo">
      <div className="flex justify-content-center">
        <div className="card">
          <h5 className="text-center">Create Client</h5>
          <form onSubmit={handleSubmit(onSubmit)} className="p-fluid">
            <div className="field">
              <span className="p-float-label">
                ...
                <label
                  htmlFor="ClnCode"
                  className={classNames({ "p-error": errors.ClnCode })}
                >
                  *Client Code
                </label>
              </span>
              {getFormErrorMessage("ClnCode")}
            </div> 
            ...
            <div className="field">
              <span className="p-float-label">
                ...
                <label
                  htmlFor="ClnName"
                  className={classNames({ "p-error": errors.ClnName })}
                >
                  *Client Name
                </label>
              </span>
              {getFormErrorMessage("ClnName")}
            </div>
            <div className="field">
              <span className="p-float-label">
                <Controller
