...
import { setSuppliers } from "../../store/supplier/action";
...
export default function CreateSupplier() {
  ...
  const onSubmit = async (data) => {
    await axios
      .post(`${process.env.REACT_APP_API_URL}/addNewSupplier`, data)
      .then((res) => {
        console.log('added');
  ...
  return (
    <div className="form-demo">
      <div className="flex justify-content-center">
        <div className="card">
          <h5 className="text-center">Create new Supplier</h5>
          <form onSubmit={handleSubmit(onSubmit)} className="p-fluid">
            <div className="field">
              <span className="p-float-label">
                ...
                <label
                  htmlFor="SupCode"
                  className={classNames({ "p-error": errors.SupCode })}
                >
                  *Supplier Code
                </label>
              </span>
              {getFormErrorMessage("SupCode")}
            </div>
            ...
            <div className="field">
              <span className="p-float-label">
                ...
                <label
                  htmlFor="SupName"
                  className={classNames({ "p-error": errors.SupName })}
                >
                  *Supplier Name
                </label>
              </span>
              {getFormErrorMessage("SupName")}
            </div>
